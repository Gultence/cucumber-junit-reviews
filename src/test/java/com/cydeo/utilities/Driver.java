...
public class Driver {   //create a private constructor to remove access to this object
    private Driver(){}
    ...
    public static WebDriver getDriver(){
        ...
        if(driver == null){
            ...
            browserType=browserType.trim().toLowerCase();// solve the problem space and uppercase problem
